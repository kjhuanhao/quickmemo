    ...
    return (
      <div
        ...
        className={cn(
          ...
          'hover:bg-accent hover:text-accent-foreground data-[highlighted=true]:bg-accent data-[highlighted=true]:text-primary',
          className
        )}
        {...props}
        {...rest}
    ...
    <Popover.Root open>
      ...
      <Popover.Portal container={portalElement}>
        <Popover.Content
          ...
          align='start'
          className={cn(
            'z-[500] m-0 max-h-[288px] w-[300px] overflow-y-auto rounded-md backdrop-blur-lg bg-opacity-10 p-0 shadow-md'
          )}
